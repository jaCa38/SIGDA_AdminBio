...
namespace SIGDA.SRHN.Libreria.Catalogos.Paises.Models
{
    public class PaisBase : BaseModel
    {
        private string _cadenaConexion = string.Empty;
        public PaisBase() { }
        public PaisBase(string CadenaConexion) => _cadenaConexion = CadenaConexion;

        public override IEnumerable<BaseModel> ConsultarCatalogoGenerico()
        {
            IEnumerable<BaseModel> lstResultado = new List<BaseModel>();

            var sql = @"[catalogo].[sp_ObtenerPaisesCatalogo]";
