...
using SIGDA.SRHN.Libreria.Catalogos.Paises.Controllers;
...
namespace SIGDA.SRHN.Libreria.Catalogos.Paises.Factorizadores
{
    public class FactorizadorPais
    {
        public static IModelGenericoService CrearConexionGenerica()
        {
            ...
            nuevoMotor = new PaisController(CadenasConexion.BDRHN_LOCAL);
