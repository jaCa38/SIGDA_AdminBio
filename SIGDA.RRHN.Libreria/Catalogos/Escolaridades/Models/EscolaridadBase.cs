...
namespace SIGDA.SRHN.Libreria.Catalogos.Escolaridades.Models
{
    public class EscolaridadBase : BaseModel
    {
        private string _cadenaConexion = string.Empty;
        public EscolaridadBase() { }
        public EscolaridadBase(string CadenaConexion) => _cadenaConexion = CadenaConexion;

        public override IEnumerable<BaseModel> ConsultarCatalogoGenerico()
        {
            IEnumerable<BaseModel> lstResultado = new List<BaseModel>();

            var sql = @"[catalogo].[sp_ObtenerEscolaridadCatalogo]";
