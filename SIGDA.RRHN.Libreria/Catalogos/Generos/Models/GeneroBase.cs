...
namespace SIGDA.SRHN.Libreria.Catalogos.Generos.Models
{
    public class GeneroBase : BaseModel
    {
        private string _cadenaConexion = string.Empty;
        public GeneroBase() { }
        public GeneroBase(string CadenaConexion) => _cadenaConexion = CadenaConexion;

        public override IEnumerable<BaseModel> ConsultarCatalogoGenerico()
        {
            IEnumerable<BaseModel> lstResultado = new List<BaseModel>();

            var sql = @"[catalogo].[sp_ObtenerSexoCatalogo]";
