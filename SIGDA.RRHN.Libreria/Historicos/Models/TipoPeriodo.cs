...
namespace SIGDA.SRHN.Libreria.Historicos.Models
{
    public class TipoPeriodo: BaseModel
    {
        private string _cadenaConexion = string.Empty;
        public TipoPeriodo() { }
        public TipoPeriodo(string CadenaConexion) => _cadenaConexion = CadenaConexion;

        public override IEnumerable<BaseModel> ConsultarCatalogoGenerico()
        {
            IEnumerable<BaseModel> lstResultado = new List<BaseModel>();

            var sql = @"[hist].[pa_TipoPeriodo_Consultar]";
